pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "messido/llmops-study-buddy"
    ...
    stages {
        stage('Checkout Github') {
            steps {
                ...
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/Messido/study-buddy-ai.git']])
            }
        }        
